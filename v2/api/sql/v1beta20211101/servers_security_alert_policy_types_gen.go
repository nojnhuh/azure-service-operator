...
func (policy *ServersSecurityAlertPolicy) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected sql/v1beta20211101storage/ServersSecurityAlertPolicy but received %T instead", hub)
	}
...
// +kubebuilder:webhook:path=/mutate-sql-azure-com-v1beta20211101-serverssecurityalertpolicy,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=sql.azure.com,resources=serverssecurityalertpolicies,verbs=create;update,versions=v1beta20211101,name=default.v1beta20211101.serverssecurityalertpolicies.sql.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-sql-azure-com-v1beta20211101-serverssecurityalertpolicy,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=sql.azure.com,resources=serverssecurityalertpolicies,verbs=create;update,versions=v1beta20211101,name=validate.v1beta20211101.serverssecurityalertpolicies.sql.azure.com,admissionReviewVersions=v1
