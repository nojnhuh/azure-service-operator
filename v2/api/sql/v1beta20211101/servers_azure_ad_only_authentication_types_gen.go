...
func (authentication *ServersAzureADOnlyAuthentication) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected sql/v1beta20211101storage/ServersAzureADOnlyAuthentication but received %T instead", hub)
	}
...
// +kubebuilder:webhook:path=/mutate-sql-azure-com-v1beta20211101-serversazureadonlyauthentication,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=sql.azure.com,resources=serversazureadonlyauthentications,verbs=create;update,versions=v1beta20211101,name=default.v1beta20211101.serversazureadonlyauthentications.sql.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-sql-azure-com-v1beta20211101-serversazureadonlyauthentication,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=sql.azure.com,resources=serversazureadonlyauthentications,verbs=create;update,versions=v1beta20211101,name=validate.v1beta20211101.serversazureadonlyauthentications.sql.azure.com,admissionReviewVersions=v1
