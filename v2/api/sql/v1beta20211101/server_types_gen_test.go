...
// RunPropertyAssignmentTestForServer tests if a specific instance of Server can be assigned to v1beta20211101storage and back losslessly
...
// RunPropertyAssignmentTestForServer_Spec tests if a specific instance of Server_Spec can be assigned to v1beta20211101storage and back losslessly
...
// RunPropertyAssignmentTestForServer_STATUS tests if a specific instance of Server_STATUS can be assigned to v1beta20211101storage and back losslessly
...
// RunPropertyAssignmentTestForServerExternalAdministrator tests if a specific instance of ServerExternalAdministrator can be assigned to v1beta20211101storage and back losslessly
...
// RunPropertyAssignmentTestForServerExternalAdministrator_STATUS tests if a specific instance of ServerExternalAdministrator_STATUS can be assigned to v1beta20211101storage and back losslessly
...
// RunPropertyAssignmentTestForServerPrivateEndpointConnection_STATUS tests if a specific instance of ServerPrivateEndpointConnection_STATUS can be assigned to v1beta20211101storage and back losslessly
...
// RunPropertyAssignmentTestForPrivateEndpointConnectionProperties_STATUS tests if a specific instance of PrivateEndpointConnectionProperties_STATUS can be assigned to v1beta20211101storage and back losslessly
...
// RunPropertyAssignmentTestForPrivateEndpointProperty_STATUS tests if a specific instance of PrivateEndpointProperty_STATUS can be assigned to v1beta20211101storage and back losslessly
...
// RunPropertyAssignmentTestForPrivateLinkServiceConnectionStateProperty_STATUS tests if a specific instance of PrivateLinkServiceConnectionStateProperty_STATUS can be assigned to v1beta20211101storage and back losslessly
