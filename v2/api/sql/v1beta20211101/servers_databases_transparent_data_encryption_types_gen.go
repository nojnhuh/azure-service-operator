...
// - ARM URI: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/transparentDataEncryption/current
...
func (encryption *ServersDatabasesTransparentDataEncryption) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected sql/v1beta20211101storage/ServersDatabasesTransparentDataEncryption but received %T instead", hub)
	}
...
// +kubebuilder:webhook:path=/mutate-sql-azure-com-v1beta20211101-serversdatabasestransparentdataencryption,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=sql.azure.com,resources=serversdatabasestransparentdataencryptions,verbs=create;update,versions=v1beta20211101,name=default.v1beta20211101.serversdatabasestransparentdataencryptions.sql.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-sql-azure-com-v1beta20211101-serversdatabasestransparentdataencryption,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=sql.azure.com,resources=serversdatabasestransparentdataencryptions,verbs=create;update,versions=v1beta20211101,name=validate.v1beta20211101.serversdatabasestransparentdataencryptions.sql.azure.com,admissionReviewVersions=v1

var _ admission.Validator = &ServersDatabasesTransparentDataEncryption{}

// ValidateCreate validates the creation of the resource
func (encryption *ServersDatabasesTransparentDataEncryption) ValidateCreate() error {
...
func (encryption *ServersDatabasesTransparentDataEncryption) ValidateDelete() error {
...
func (encryption *ServersDatabasesTransparentDataEncryption) ValidateUpdate(old runtime.Object) error {
...
func (encryption *ServersDatabasesTransparentDataEncryption) createValidations() []func() error {
	return []func() error{encryption.validateResourceReferences}
}

// deleteValidations validates the deletion of the resource
func (encryption *ServersDatabasesTransparentDataEncryption) deleteValidations() []func() error {
	return nil
}

// updateValidations validates the update of the resource
func (encryption *ServersDatabasesTransparentDataEncryption) updateValidations() []func(old runtime.Object) error {
...
func (encryption *ServersDatabasesTransparentDataEncryption) validateResourceReferences() error {
...
func (encryption *ServersDatabasesTransparentDataEncryption) validateWriteOnceProperties(old runtime.Object) error {
