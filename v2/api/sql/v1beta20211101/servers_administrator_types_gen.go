...
// - ARM URI: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/administrators/ActiveDirectory
...
func (administrator *ServersAdministrator) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected sql/v1beta20211101storage/ServersAdministrator but received %T instead", hub)
	}
...
// +kubebuilder:webhook:path=/mutate-sql-azure-com-v1beta20211101-serversadministrator,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=sql.azure.com,resources=serversadministrators,verbs=create;update,versions=v1beta20211101,name=default.v1beta20211101.serversadministrators.sql.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-sql-azure-com-v1beta20211101-serversadministrator,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=sql.azure.com,resources=serversadministrators,verbs=create;update,versions=v1beta20211101,name=validate.v1beta20211101.serversadministrators.sql.azure.com,admissionReviewVersions=v1
